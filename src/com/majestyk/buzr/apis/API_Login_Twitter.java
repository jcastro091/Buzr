...
public class API_Login_Twitter extends AsyncTask<String, Void, String> {

	Context c;
	OnTaskCompleteListener complete;
	ProgressDialog dialog;

	public API_Login_Twitter (Context c, OnTaskCompleteListener complete) {
		this.c = c;
	...
	protected String doInBackground(String... params) {
		...
		System.out.println("twitter token - " + params[1]);
		nameValuePairs.add(new BasicNameValuePair("twitter_token",			params[1]));
		nameValuePairs.add(new BasicNameValuePair("twitter_token_secret",	params[2]));
