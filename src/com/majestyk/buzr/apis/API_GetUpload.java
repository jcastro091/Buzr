...
public class API_GetUpload extends AsyncTask<String, Void, String> {

	Context c;
	OnTaskCompleteResultListener complete;
	
	public API_GetUpload (Context c, OnTaskCompleteResultListener complete) {
		this.c = c;
	...
	protected String doInBackground(String... params) {
		...
		System.out.println("MY UPLOAD ID IS: " + params[1]);
