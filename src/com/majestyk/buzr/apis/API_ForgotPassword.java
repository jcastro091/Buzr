...
public class API_ForgotPassword extends AsyncTask<String, Void, String> {

	Context c;
	OnTaskCompleteListener complete;

	public API_ForgotPassword (Context c, OnTaskCompleteListener complete) {
		this.c = c;
	...
	public void onPostExecute(String result) {
		try {
			...
			if (result.trim().equals("true")) {
				Toast.makeText(c, "You will receive an email with a temporary password. " + 
						"Please choose a new password after you have logged in.", 
