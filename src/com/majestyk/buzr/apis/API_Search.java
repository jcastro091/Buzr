...
public class API_Search extends AsyncTask<String, Void, String> {

	Context c;
	Boolean flag;
	OnTaskCompleteResultListener complete;
	
	public API_Search (Context c, Boolean b, OnTaskCompleteResultListener complete) {
		this.c = c;
		this.flag = b;
	...
	protected String doInBackground(String... params) {
		...
		if(flag)
			nameValuePairs.add(new BasicNameValuePair("hashtag",	params[1]));
		else
			nameValuePairs.add(new BasicNameValuePair("q",	params[1]));
