...
public class API_Suggested extends AsyncTask<String, Void, String> {

	Context c;
	OnTaskCompleteResultListener complete;
	
	public API_Suggested (Context c, OnTaskCompleteResultListener complete) {
		this.c = c;
	...
	protected String doInBackground(String... params) {
		...
		nameValuePairs.add(new BasicNameValuePair("screen",		params[1]));
		nameValuePairs.add(new BasicNameValuePair("start",		params[2]));
