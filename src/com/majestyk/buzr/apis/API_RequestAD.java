...
public class API_RequestAD extends AsyncTask<String, Void, String> {

	Context c;
	OnTaskCompleteListener complete;
	
	public API_RequestAD (Context c, OnTaskCompleteListener complete) {
		this.c = c;
	...
	protected String doInBackground(String... params) {
		...
		nameValuePairs.add(new BasicNameValuePair("follow_id",	params[1]));
